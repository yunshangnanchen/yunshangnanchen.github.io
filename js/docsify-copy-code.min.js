    ...
    window.$docsify = window.$docsify || {}, window.$docsify.plugins = [
        function (o, t) {
            ...
            o.doneEach((function () {
                ...
                var c = ['<button class="docsify-copy-code-button">',
                    '<span class="label">'.concat(n.buttonText, "</span>"),
                    '<span class="error" aria-hidden="hidden">'.concat(n.errorText, "</span>"),
                    '<span class="success" aria-hidden="hidden">'.concat(n.successText, "</span>"),
